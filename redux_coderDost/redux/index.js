...
function getUserAccount(id) {
  ...
  return async (dispatch, getState) => {
    // getState: contains global state variables
    try {
      // to show loader on the top until promise didn't get fulfilled/ reject state
      dispatch(getUserAccount_pending());
      console.log('state is: ', getState); // getState: contains global state variables
